<template>
    <div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white">
        <div class="text-center">
            ...
            <div class="p-4">
                <button
                    class="w-25 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" @click="reloadNuxtApp({path: '/', ttl: 1000})">
                    Back Home
                </button>
            </div>
        </div>
